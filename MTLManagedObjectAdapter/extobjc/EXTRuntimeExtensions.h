...
typedef enum {
     ...
     */
    mtl_moa_propertyMemoryManagementPolicyAssign = 0,

    /**
     * The value is retained.
     */
    mtl_moa_propertyMemoryManagementPolicyRetain,

    /**
     * The value is copied.
     */
    mtl_moa_propertyMemoryManagementPolicyCopy
} mtl_moa_propertyMemoryManagementPolicy;
...
typedef struct {
     ...
     * #mtl_moa_propertyMemoryManagementPolicyAssign if #readonly is \c YES.
     */
    mtl_moa_propertyMemoryManagementPolicy memoryManagementPolicy;
